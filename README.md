...
## 📖 Overview
**Yaqazah** is a real-time driver monitoring system that predicts drowsiness using computer vision and lightweight deep learning.  
By analyzing facial landmarks and ocular metrics on standard mobile devices, Yaqazah eliminates the need for specialized hardware.

The system shifts road safety from reactive detection to proactive prevention by identifying early signs of fatigue before they become critical.
